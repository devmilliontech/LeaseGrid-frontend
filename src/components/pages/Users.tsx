  ...
  return (
    <>
      <div className="px-2 py-2 space-y-6 max-w-[1600px] mx-auto">
        ...
        {/* Users Table Card */}
        <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 h-155 min-h-[420px] max-h-[1250px] overflow-y-auto">
        ...
        <div className="min-h-[420px] max-h-[1250px] ">
          <div className="bg-white p-6 rounded-3xl border border-slate-100">
            <div className="flex flex-col mb-6">
              <p className={header1}>User Activity Analytics</p>
              <p className={subHeader}>User engagement and platform activity metrics</p>
            </div>
