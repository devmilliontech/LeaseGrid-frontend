...
import { UsersListCard, UsersFilterCard, UserTable, BulkActions, ActivityAnalyticsCard } from "../appShell/user/UserCard";
        ...
        <div className="min-h-[420px] max-h-[1250px] ">
          <div className="bg-white p-6 rounded-3xl border border-slate-100">
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    <ActivityAnalyticsCard data={activityAnalyticsData} />
               </div>
          </div>
        </div>
      </div>
